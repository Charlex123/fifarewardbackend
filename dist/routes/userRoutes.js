...
const { checkloginEmail, openBet, authUser, registerUser, resendverificationMail, updateUserProfile, verifyUser, updateTransactionPin, resetPassword, checkEmail, checkUserName, activateAccount, checkForgotEmail, getReferrals, updateWalletAddress, getSponsor, getWalletAddress } = require("../controllers/userController");
