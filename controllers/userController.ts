...
// async..await is not allowed in global scope, must use a wrapper
  ...
  const verificationSuccess = (username:string,email:string, res:any) => {
      ...
      <style type='text/css'>
        ...
        <body>
          <div>
            ...
            <a href="https://fifareward.io/signin">Confirm Email</a>
            <br>
            <div>
                <p>
    ...
    if(sender){
      console.log("Message sent: %s", sender.messageId);
      // Message sent: <b658f8ca-6296-ccf4-8306-87d57a0b4321@example.com>
      res.redirect(`https://fifareward.io/accountactivatestatus/${username}`)
      // Preview only available when sending through an Ethereal account
      console.log("Preview URL: %s", nodemailer.getTestMessageUrl(sender));
      // Preview URL: https://ethereal.email/message/WaQKMgKddxQDoou...
    }
...
module.exports = { getWalletAddress,getSponsor,updateWalletAddress,getReferrals,activateAccount,checkEmail, checkForgotEmail,checkUserName, authUser, updateUserProfile, registerUser, verifyUser, resendverificationMail, resetPassword, updateTransactionPin };
