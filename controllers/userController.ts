...
//             <a href="https://www.fifareward.io/signin">Sign In</a>
//             <br>
//             <div>
//                 <p>
...
//     if(status == 'Active') {
//       // get user id
//       const getuserdet = await User.findOne({email: email});
//       //check if user has a referral
//       if(getuserdet) {
//         res.status(201).json({
//           _id: getuserdet._id,
//           username: getuserdet.username,
//           userId: getuserdet.userId,
//           sponsorId: getuserdet.sponsorId,
//           email: getuserdet.email,
//           isinfluencer: getuserdet.isinfluencer,
//           badge: getuserdet.badge,
//           tpin: getuserdet.tpin,
//           status: getuserdet.status,
//           activated: getuserdet.activated,
//           isAdmin: getuserdet.isAdmin,
//           bscwalletaddress: getuserdet.bscwalletaddress,
//           pic: getuserdet.pic,
//           token: generateToken(getuserdet._id),
//         });
//       }
//     }else {
//       res.json({
...
//   const { userId, filePath_ } = req.body;
//   const uId = userId;
//   const gUser = await User.findOne({userId: userId});
//   if (gUser) {
//     gUser.verified = true;
//     gUser.pic = filePath_;
...
//     if(found__User) {
//       const foundUser = await User.updateOne(
//         {userId:userId}, { $set: {pic: filePath_}});

//       if(foundUser) {
//         const foundUser_ = await User.findOne({userId: userId});
//         res.json({
//           pic: foundUser_.pic,
//         });
//       }
...
//   const users = await User.find({}, 'username pic -_id'); // Select username and profilePic, exclude _id
//   if(users) {
//     res.json({
//       data: users
//     });
...
// module.exports = { checkloginEmail, openBet,activateAccount,checkEmail, checkForgotEmail,checkUserName, authUser, updateUserProfile, verifyUser, resendverificationMail, resetPassword, updateTransactionPin, UpdateprofilePicture, getUsers };
